...
Route::middleware('isLogin')->group(function () {
    ...
    Route::middleware('isPetugasAdmin')->group(function () {
        ...
        Route::get('/petugas/pengaduan/pending', [PengaduanController::class, 'pending'])->name('pengaduan.pending');
        Route::get('/petugas/pengaduan/proses', [PengaduanController::class, 'proses'])->name('pengaduan.proses');
        Route::get('/petugas/pengaduan/selesai', [PengaduanController::class, 'selesai'])->name('pengaduan.selesai');
        
        Route::get('/cetak/{cetak}', [PengaduanController::class, 'pengaduanPDF'])->name('cetak.pdf');
